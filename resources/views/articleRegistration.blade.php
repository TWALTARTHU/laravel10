...
<section>
    <form action="/kadai03/detail" method="get" enctype="multipart/form-data">
        ...
        <div class="flex justify-end">
            ...
            <button type="submit"
                class="block w-20 text-white text-center bg-red-600 hover:bg-sky-500 px-3 py-2 rounded-md">投稿</button>
        </div>
    </form>
</section>
